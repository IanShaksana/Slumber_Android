...
public class RingActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ring_sleep);
        ...
        if (sh.getInt(string_access_1, 99) == 99 && sh.getInt(string_access_2, 99) == 99) {
            RingActivity1.this.startActivity(new Intent(RingActivity1.this, MainActivity.class));
            finish();
        }
        ...
        dismiss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentService1 = new Intent(getApplicationContext(), alarm_service1.class);
                getApplicationContext().stopService(intentService1);
                SharedPreferences sh = getSharedPreferences("State", MODE_PRIVATE);
    ...
    private void report(model_profile model) {
        try {
            http_post post = new http_post(RingActivity1.this);
            Gson gson = new Gson();
            JSONObject jo = new JSONObject(gson.toJson(model));
            jo.put("api", getString(R.string.report_sleep));
            post.execute(jo);
                ...
                public void onUpdate(JSONObject JObject) {
                    ...
                    try {
                        ...
                        if (!JObject.getString("statuscode").equals("OK")) {
                            Toast.makeText(RingActivity1.this, "Gagal : " + JObject.getString("message"), Toast.LENGTH_SHORT).show();
                        } else if (JObject.getString("statuscode").equals("no connection")) {
                            Toast.makeText(RingActivity1.this, "Tidak ada koneksi ke server", Toast.LENGTH_SHORT).show();
                        } else {
