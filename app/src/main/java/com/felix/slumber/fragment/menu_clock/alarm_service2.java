...
public class alarm_service2 extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Intent notificationIntent = new Intent(this, RingActivity2.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);

        createNotificationChannel(this);


        Notification notification = new NotificationCompat.Builder(this, "slumber_wake")
                .setSmallIcon(R.drawable.logo_slumber)
                .setContentTitle("Slumber Wakey Wakey")
                .setContentIntent(pendingIntent)
                .setContentText("Today Will Be A Good DAY So WAKE UP and SMILE")
    ...
    private void createNotificationChannel(Context k1) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("slumber_wake", name, importance);
