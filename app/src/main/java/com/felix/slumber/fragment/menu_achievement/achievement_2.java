...
public class achievement_2 extends Fragment {
                ...
                public void onUpdate(JSONObject JObject) {
                    ...
                    try {
                        ...
                        if (!JObject.getString("statuscode").equals("OK")) {
                            ...
                            if (!data.isNull("weekly")) {
                                JSONObject weekly = data.getJSONObject("weekly");
                                idtask = weekly.getString("id");
                                get_mission_daily(data.getInt("progress_weekly"), data.getInt("rep_weekly"), data.getString("title_weekly"), weekly.getInt("status"), data.getInt("point_weekly"));
                            } else {
                                // Toast.makeText(getContext(), "Sukses", Toast.LENGTH_SHORT).show();
                                title.setText("No weekly mission");
