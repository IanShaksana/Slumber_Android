...
public class dialog_hp extends AppCompatDialogFragment {
    ...
    public dialog_hp(String title, String iditem) {
        this.title = title;
        this.iditem = iditem;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_text_hp, null);
        editText = view.findViewById(R.id.dialog_input);
        cross = view.findViewById(R.id.cross);
        btn = view.findViewById(R.id.btn);
        textView = view.findViewById(R.id.text);

        textView.setText("Input your phone number (" + title + ")");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dialog != null) {
                    listener.apply_hp(dialog, iditem);
                    dismiss();
                }
            }
        });
    ...
    public interface dialogListener_worker {
        void apply_hp(String email, String iditem);
    }
